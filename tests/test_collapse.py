...
from f4epurity.collapse import (
    extract_flux_values,
    get_flux_from_vtk,
    extract_xs,
    perform_collapse,
...
def test_extract_xs():
    ...
    expected_output = [8.6890e00, 2.1642e00, 4.3089e-03, 1.3517e-03, 1.3366e-04]
...
def test_collapse_flux():
    ...
    expected_result = np.array(
        [perform_collapse(xs_values, flux) for flux in flux_spectrum]
    )
