...
from f4epurity.utilities import get_molar_mass, get_isotopes, add_user_irrad_scenario, normalise_nuclide_name, convert_names
...
def test_add_user_irrad_scenario():
    ...
    day_to_sec = 24 * 60 * 60
    my_scenario = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data', 'my_irrad_scenario.txt')
    irrad_scenarios = {}
